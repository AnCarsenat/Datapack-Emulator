...
:mod:`datapack_emulator.emulator.version_data`, so it is the real command list of the real
version, not a guess.
"""
...
from datapack_emulator.emulator.commands.handlers import HANDLERS, Handler
...
class CommandSet:
    ...
    def _removed(feature: str) -> Version | None:
        from datapack_emulator.emulator.version_data import FEATURE_UNTIL
