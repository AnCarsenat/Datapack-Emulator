...
Every widget is declared in ``src/datapack_emulator/window/window.ui`` and looked up by object
...
from datapack_emulator.project import Project, default_sample, projects_dir
from datapack_emulator.settings import EMULATION, PATHS, WINDOW
