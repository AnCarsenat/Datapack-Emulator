...
| file › open the last project on launch | a tick, on by default: the window starts on that project (the sample datapack when there is none, or when it is off) |
...
```sh
datapack-emulator projects/hat.dpemu     # open this project
datapack-emulator samples/hat            # open this datapack
